...
<body>
    ...
    <div class="grid inspiration-container">
        <div class="inspiration">
            ...
            <svg class="inspiration-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" viewBox="0 0 960 1207">
            <defs>
                <pattern id="pattern" width="1" height="1" viewBox="0 74.549 960 1207">
                <image preserveAspectRatio="xMidYMid slice" width="960" height="1280" xlink:href="./assets/static/home/inspirations1.jpg"/>
                </pattern>
            ...
            <g id="Inspiration" transform="translate(-15.586 -870.055)">
                <rect id="inspirations1" width="960" height="1207" rx="8" transform="translate(15.587 870.055)" fill="url(#pattern)"/>
                <rect id="inspirations1-2" data-name="inspirations1" width="960" height="1207" rx="8" transform="translate(15.587 870.055)" fill="url(#linear-gradient)"/>
        ...
        <div class="more-inspiration">
            ...
            <div id="inspirations-group" class="inspirations-group">
